...
@interface TFY_CacheFileImage ()<UIScrollViewDelegate>
@property (nonatomic, strong) UILabel *titleLabel;
@property (nonatomic, strong) UIScrollView *scrollView;
@end

@implementation TFY_CacheFileImage
...
- (void)reloadImages
{
    if (self.images && self.images.count > 0) {
        ...
        //
        TFY_CacheFileImage __weak *weakSelf = self;
        [self.images enumerateObjectsUsingBlock:^(id  _Nonnull obj, NSUInteger idx, BOOL * _Nonnull stop) {
            ...
            TFY_CacheScaleImage *imageView = [[TFY_CacheScaleImage alloc] initWithFrame:rect];
...
@interface TFY_CacheScaleImage () <UIScrollViewDelegate>

@property (nonatomic, strong) UIImageView *imageView;

@end

@implementation TFY_CacheScaleImage
